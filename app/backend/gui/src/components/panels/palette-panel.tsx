...
import { LayoutGrid, Zap, MessageSquare, GitMerge, Cog, Timer, Webhook, SlidersHorizontal, Globe, Shuffle, GitFork } from 'lucide-react'; // Added Shuffle, GitFork
...
const paletteItems = [
  ...
  { name: 'Conditional (If/Else)', type: 'conditional', icon: <GitFork className="h-4 w-4" /> },
  { name: 'Data Transform', type: 'data-transform', icon: <Shuffle className="h-4 w-4" /> },
