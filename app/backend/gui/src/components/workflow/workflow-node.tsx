...
import { Bot, CheckCircle, AlertTriangle, Clock, HelpCircle, MessageSquare, GitMerge, Zap, Timer, Webhook, SlidersHorizontal, Cog, Globe, Shuffle, GitFork } from 'lucide-react';
...
export interface WorkflowNodeData {
  ...
  config?: {
    ...
    transformationLogic?: string; // For data-transform node
...
const typeIcons: Record<NodeType, React.ReactNode> = {
  ...
  conditional: <GitFork className="h-4 w-4 text-lime-500" />, // New icon
  'data-transform': <Shuffle className="h-4 w-4 text-rose-500" />, // New icon
};
